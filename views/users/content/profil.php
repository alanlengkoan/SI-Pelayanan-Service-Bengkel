        ...
        <div class="panel-body">
            <form action="aksi/?aksi=profil_upd" id="form-add" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="inpnama" id="inpnama" placeholder="Masukkan nama" value="<?= $rowLog->nama ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">E-Mail *</label>
                    <div class="col-sm-8">
                        <input type="email" class="form-control" name="inpemail" id="inpemail" placeholder="Masukkan email" value="<?= $rowLog->email ?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">Username *</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="inpusername" id="inpusername" placeholder="Masukkan username" value="<?= $rowLog->username ?>" />
                    </div>
                </div>
                <div class="form-group">

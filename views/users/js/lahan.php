...
<script>
    ...
    var untukAmbilIdData = function() {
        $(document).on('click', '#upd', function() {
            ...
            $.ajax({
                type: "post",
                url: "aksi/?aksi=lahan_get",
                dataType: 'json',
                data: {
                    id_lokasi: ini.data('id'),
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    $('form').attr('action', 'aksi/?aksi=lahan_upd');
                    $('form').attr('id', 'form-upd');
                    $('#inpidlokasi').val(data.id_lokasi);
                    $.each(data.detail, function(index, value) {
                        $(inpnilai[index]).val(value['nilai']);
                    });
                    $('#add').html('<i class="fa fa-save"></i> Ubah');

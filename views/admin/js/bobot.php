...
<script>
    ...
    var untukTambahData = function() {
        ...
        $('#form-add').submit(function(e) {
            ...
            $('#inpidkriteria').attr('required', 'required');
            $('#inpparameter').attr('required', 'required');
        ...
        $(document).on('click', '#upd', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('form').attr('action', 'aksi/?aksi=bobot_upd');
                    $('form').attr('id', 'form-upd');
                    $('#inpidparamater').attr('value', data.id_parameter);
                    $('#inpidkriteria').val(data.id_atribut);
                    $('#inpparameter').val(data.parameter);
                    $('#inpnilai').attr('value', data.nilai);

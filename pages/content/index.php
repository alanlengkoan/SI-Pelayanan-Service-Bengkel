<div id="loading">
    <div id="loading-center">
        <img src="../assets/landing_page/images/loader.gif" alt="">
    </div>
</div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <ul class="menu-logo">
                                <li>
                                    <a href="index"><img id="logo_img" src="../assets/landing_page/images/logo-light.png" alt="logo"> </a>
                                </li>
                            </ul>
                            <ul class="menu-links">
                                <li class="active">
...
<section class="slider">
    <div id="rev_slider_2_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="car-dealer-03" style="margin:0 auto;background-color:transparent;padding:0;margin-top:0;margin-bottom:0">
        <div id="rev_slider_2_1" class="rev_slider fullwidthabanner" style="display:none" data-version="5.2.6">
            <ul>
                <li data-index="rs-1" data-transition="random-static,random-premium,random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-randomtransition="on">
                    <img src="../assets/landing_page/images/slider/1.jpg" alt="" />
                    <div class="tp-caption tp-resizeme" id="slide-3-layer-1" data-x="62" data-y="179" data-width="['auto']" data-height="['auto']" data-type="text" data-responsive_offset="on" data-frames='[{"delay":500,"speed":1500,"frame":"0","from":"x:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"nothing"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index:5;white-space:nowrap;font-size:70px;line-height:80px;font-weight:900;color:rgba(255,255,255,1.00);font-family:Roboto;text-transform:uppercase">
                        Sistem Informasi Call Service
                    </div>
                </li>
                <li data-index="rs-2" data-transition="random-static,random-premium,random" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-randomtransition="on">
                    <img src="../assets/landing_page/images/slider/2.jpg" alt="" />
                    <div class="tp-caption tp-resizeme" id="slide-3-layer-1" data-x="62" data-y="179" data-width="['auto']" data-height="['auto']" data-type="text" data-responsive_offset="on" data-frames='[{"delay":500,"speed":1500,"frame":"0","from":"x:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"nothing"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index:5;white-space:nowrap;font-size:70px;line-height:80px;font-weight:900;color:rgba(255,255,255,1.00);font-family:Roboto;text-transform:uppercase">
                        Sistem Informasi Call Service
                    </div>
                </li>
...
<section class="welcome-block objects-car page-section-ptb white-bg portfolio-main">
    <div class="objects-left left"><img class="img-responsive objects-1" src="../assets/landing_page/images/objects/01.png" alt=""></div>
    <div class="objects-right right"><img class="img-responsive objects-2" src="../assets/landing_page/images/objects/02.png" alt=""></div>
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="halp-call text-center">
                    <img class="img-responsive" src="../assets/landing_page/images/team/01.jpg" alt="" />
                ...
                <div class="owl-carousel-1">
                    <div class="item">
                        <div class="car-item text-center">
                            <div class="car-image">
                                <img class="img-responsive" src="../assets/landing_page/images/car/02.jpg" alt="" />
                    ...
                    <div class="item">
                        <div class="car-item text-center">
                            <div class="car-image">
                                <img class="img-responsive" src="../assets/landing_page/images/car/01.jpg" alt="" />
                                <div class="car-overlay-banner">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                        <li><a href="#"><i class="fa fa-dashboard"></i></a></li>
                    ...
                    <div class="item">
                        <div class="car-item text-center">
                            <div class="car-image">
                                <img class="img-responsive" src="../assets/landing_page/images/car/05.jpg" alt="" />
                                <div class="car-overlay-banner">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-link"></i></a></li>
                                        <li><a href="#"><i class="fa fa-dashboard"></i></a></li>
...
<section class="bg-5">
    <div class="container-fluid">
        <div class="row no-gutter">
            <div class="col-lg-6 col-md-6 gray-bg text-center">
        ...
        <div class="blog-1">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <img class="img-responsive" src="../assets/landing_page/images/blog/01.png" alt="" />
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="blog-content">
                        <a class="link" href="#">Porsche 911 is text of the printin a galley of type and bled it to make a type specimen book.
                        </a>
                        <span class="uppercase">November 29, 2018 |
                            <strong class="text-red">post by john doe
                            </strong>
                        </span>
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-10">
                <div class="video-info text-center">
                    <img class="img-responsive" src="../assets/landing_page/images/car/24.jpg" alt="" />
            ...
            <div class="col-lg-12 col-md-12">
                <div class="owl-carousel-2">
                    <div class="item">
                        <div class="testimonial-block text-center border-new">
                            <div class="testimonial-image">
                                <img class="img-responsive" src="../assets/landing_page/images/testimonial/01.jpg" alt="" />
                            </div>
                    ...
                    <div class="item">
                        <div class="testimonial-block text-center border-new">
                            <div class="testimonial-image">
                                <img class="img-responsive" src="../assets/landing_page/images/testimonial/02.jpg" alt="" />
                            </div>
                            <div class="testimonial-box">
                                <div class="testimonial-avtar">
                                    <img class="img-responsive" src="../assets/landing_page/images/team/02.jpg" alt="" />
                                    <h6>Michael Bean</h6>
                    ...
                    <div class="item">
                        <div class="testimonial-block text-center border-new">
                            <div class="testimonial-image">
                                <img class="img-responsive" src="../assets/landing_page/images/testimonial/03.jpg" alt="" />
                            </div>
                            <div class="testimonial-box">
                                <div class="testimonial-avtar">
                                    <img class="img-responsive" src="../assets/landing_page/images/team/03.jpg" alt="" />
                                    <h6>Felica Queen</h6>
                                    <span>Auto Dealer</span>
                                </div>
                                <div class="testimonial-content">
                    ...
                    <div class="item">
                        <div class="testimonial-block text-center border-new">
                            <div class="testimonial-image">
                                <img class="img-responsive" src="../assets/landing_page/images/testimonial/04.jpg" alt="" />
                            </div>
                            <div class="testimonial-box">
                                <div class="testimonial-avtar">
                                    <img class="img-responsive" src="../assets/landing_page/images/team/04.jpg" alt="" />
                                    <h6>Sara Lisbon</h6>
                                    <span>Customer</span>
                                </div>
                                <div class="testimonial-content">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="about-content">
                    <a href="#">
                        <img class="img-responsive" src="../assets/landing_page/images/logo-light.png" alt=""></a>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="recent-post-block">
                    ...
                    <div class="recent-post">
                        <div class="recent-post-image">
                            <img class="img-responsive" src="../assets/landing_page/images/car/03.jpg" alt="">
                        </div>
                        <div class="recent-post-info">
...
<div class="car-top">
    <span><img src="../assets/landing_page/images/car.png" alt=""></span>
</div>